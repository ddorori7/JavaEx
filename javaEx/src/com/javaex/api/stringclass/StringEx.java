...
//		stringMethodsEx();
	...
	private static void stringBufferEx() {
		...
		System.out.println(sb); // -> 여기서 최종 문자열 생성(toString()이 호출) 
	...
	private static void stringMethodsEx() {
		// 유용한 메서드들
		String str = "Java Programming, JavaScript Progrmming";
		...
		idx = str.indexOf("Java", 4); // 인덱스 4 부터 Java 검색
		...
		// 문자열 추출
		System.out.println("substring 5~: " + str.substring(5)); // 인덱스 5번부터 끝까지 
		System.out.println("substring 5~16: " + str.substring(5, 16)); // 5 ~ 16(15) 앞까지
