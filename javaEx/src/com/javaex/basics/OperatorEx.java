...
//		bitShiftOperEx();
	...
	private static void bitShiftOperEx() {
		...
		// 우측 시프트(>>>)
		System.out.println(Integer.toBinaryString(val >>> 2)); // 숫자의미x(바이너리 테이터 형태로 처리)
	...
	private static void arithOperEx() {
		...
		System.out.println(a % b); // 정수 나눗셈의 나머ㅣㅈ
		...
		// 나눗셈 보충
		//System.out.println(4 / 0); // ArithmeticException /Error(예외)->종료/프로그램 비정상 종료
