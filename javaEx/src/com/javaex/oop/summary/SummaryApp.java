...
public class SummaryApp {
	...
	public static void main(String[] args) {
		...
		h1.say(); // Animal 추상 메서드 > 자식클래스에서 반드시 오버라이드해서 구현
		fight(h1); fly(h1);
		...
		p2.eat(); // KungfuPanda implements KungfuSkill
		p2.say();
		fight(p2); fly(p2);
	}

	
	private static void fly(Animal actor) {// actor가 Flyable 인터페이스를 구현?
